...
def check_ci(workflow: dict[str, Any]) -> None:
    ...
    require_line(api, "cd unraid-plugin/api && npm ci && npm audit --audit-level=high && npm test && npx tsc --noEmit && npx tsc", "CI API gate is incomplete")
    require_line(web, "cd unraid-plugin/web && npm ci && npm audit --audit-level=high && npm test && npx vue-tsc --noEmit && npm run build", "CI web gate is incomplete")
...
def check_release(workflow: dict[str, Any]) -> None:
    ...
    require_line(release_api, "cd unraid-plugin/api && npm ci && npm audit --audit-level=high && npm test && npx tsc --noEmit && npx tsc", "release API gate is incomplete")
    require_line(release_web, "cd unraid-plugin/web && npm ci && npm audit --audit-level=high && npm test && npx vue-tsc --noEmit && npm run build", "release web gate is incomplete")
