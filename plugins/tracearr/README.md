...
This is a **skills-only** plugin (no MCP server). The skill drives the Tracearr REST API
...
to write them to `~/.config/lab-tracearr/config.json`, which the skill scripts load
