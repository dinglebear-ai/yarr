...
`@dinglebear/yarr@2.2.2` npm launcher, no committed platform binary). Verify that
exact package with `npm view @dinglebear/yarr@2.2.2 version` before installation.
